...
st.markdown("<div style='text-align: center; color: #718096; font-size: 0.9rem;'>© 2026 Machine Learning Projects Hub | Designed by Harsh Choudhary</div>", unsafe_allow_html=True)
